...
if(isset($_POST['submit']))
{
  ...
  $sql="insert into professional values('','$name','$email','$pass','$address','$zipcode','$service')";
...
<section class="formpage">
    ...
    <div class="container2">
     ...
     <div>
      ...
      <label>
      <div>
        <label for="name"><b>Service Provide</b></label>
        <input required type="text" name="serice">
      </div>
      <label>
